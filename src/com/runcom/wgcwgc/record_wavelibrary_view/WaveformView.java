...
/**
 * WaveformView 这个根据你的音频进行处理成完整的波形 如果文件很大可能会很慢哦
 */
...
public class WaveformView extends View
{
	...
	public WaveformView(Context context , AttributeSet attrs)
	{
		...
		mGridPaint.setColor(getResources().getColor(R.color.grid_line ,null));

		mSelectedLinePaint = new Paint();
		mSelectedLinePaint.setAntiAlias(false);
		mSelectedLinePaint.setColor(getResources().getColor(R.color.waveform_selected ,null));

		mUnselectedLinePaint = new Paint();
		mUnselectedLinePaint.setAntiAlias(false);
		mUnselectedLinePaint.setColor(getResources().getColor(R.color.waveform_unselected ,null));

		mUnselectedBkgndLinePaint = new Paint();
		mUnselectedBkgndLinePaint.setAntiAlias(false);
		mUnselectedBkgndLinePaint.setColor(getResources().getColor(R.color.waveform_unselected_bkgnd_overlay ,null));

		mBorderLinePaint = new Paint();
		mBorderLinePaint.setAntiAlias(true);
		mBorderLinePaint.setStrokeWidth(1.5f);
		mBorderLinePaint.setPathEffect(new DashPathEffect(new float []
		{ 3.0f, 2.0f } , 0.0f));
		mBorderLinePaint.setColor(getResources().getColor(R.color.selection_border ,null));

		mPlaybackLinePaint = new Paint();
		mPlaybackLinePaint.setAntiAlias(false);
		mPlaybackLinePaint.setColor(getResources().getColor(R.color.playback_indicator ,null));

		mTimecodePaint = new Paint();
		mTimecodePaint.setTextSize(12);
		mTimecodePaint.setAntiAlias(true);
		mTimecodePaint.setColor(getResources().getColor(R.color.timecode ,null));
		mTimecodePaint.setShadowLayer(2 ,1 ,1 ,getResources().getColor(R.color.timecode_shadow ,null));
	...
	{
		// double z = mZoomFactorByZoomLevel[mZoomLevel];
		return (int) (mSoundFile.getmNumFramesFloat() * 1 * (1000.0 * mSamplesPerFrame) / (mSampleRate * 1) + 0.5);
	}
